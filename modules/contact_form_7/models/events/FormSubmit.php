...
class FormSubmit extends Event
{
    ...
    {
        return __('Form Submit', WPNE_CF7);
    }
    ...
    {
        $this->subject = __('Form "[form-name]" submit', WPNE_CF7);
        $this->message = __("Form \"[form-name]\" submit\n\n[form-all-fields]", WPNE_CF7);
    ...
    public function tag_labels($form = null)
    {
        ...
        return array_merge([
            __('Form', WPNE_CF7) => ContactForm7::labels($form),
        ], parent::tag_labels());
    }
